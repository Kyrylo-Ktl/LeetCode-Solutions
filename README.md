...
|:------------:|:------------------:|:--------------------:|:---------------------:|:----------------------:|:-------------------------:|:-------------------------:|
|     $1$      |        $1$         |         $1$          |          $1$          |          $1$           |            $1$            |            $1$            |
|   $\log n$   |   $pprox 3.32$   |    $pprox 6.64$    |    $pprox 9.97$     |  $pprox 1.33 * 10$   |    $pprox 1.66 * 10$    |    $pprox 1.99 * 10$    |
|     $n$      |        $10$        |      $10^{2}$      |      $10^{3}$       |       $10^{4}$       |        $10^{5}$         |        $10^{6}$         |
| $n * \log n$ |    $3.32 * 10$     |  $6.64 * 10^{2}$   |   $9.97 * 10^{3}$   |   $1.33 * 10^{5}$    | $pprox 1.66 * 10^{6}$ | $pprox 1.99 * 10^{7}$ |
|  $n^{2}$   |     $10^{2}$     |      $10^{4}$      |      $10^{6}$       |       $10^{8}$       |        $10^{10}$        |        $10^{12}$        |
|  $2^{n}$   | $pprox 10^{3}$ | $pprox 10^{30}$  | $pprox 10^{301}$  | $pprox 10^{3010}$  |  $pprox 10^{30102}$   |  $pprox 10^{301030}$  |
|     $n!$     | $pprox 10^{7}$ | $pprox 10^{156}$ | $pprox 10^{2568}$ | $pprox 10^{35660}$ |  $pprox 10^{456574}$  | $pprox 10^{5565709}$  |
...
Solution table for problems was generated automatically on 2022-09-23 13:46 +0000
