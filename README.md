...
| $n * \log n$ |     $3.32 * 10$     |   $6.64 * 10^{2}$   |   $9.97 * 10^{3}$    |    $1.33 * 10^{5}$    | $\approx 1.66 * 10^{6}$ | $\approx 1.99 * 10^{7}$ |
...
Solution table for problems was generated automatically on 2022-09-23 13:50 +0000
